...
public class ReaderByIndexerTest {
	...
	public static String search(String indexDir, String q) throws Exception {
		...
		PerFieldAnalyzerWrapper aWrapper = new PerFieldAnalyzerWrapper(new StandardAnalyzer(Version.LUCENE_47),
				analyzerPerField);

		QueryParser parser = new MultiFieldQueryParser(Version.LUCENE_47, new String[] { "header", "body" }, aWrapper);
